...
Pad::Pad(SE::SimpleRenderer* renderer, float velocityX, float velocityY)
	...
	, m_pad(std::make_shared<SE::Rectangle>(SE::vec3(5.0f, 190.0f, 0.0f), SE::vec2(20, 5), SE::vec3(1, 1, 1), Texture("..\\..\\src\\studious-engine\\PublicFiles\\Textures\\platform_1.png"), 2))
{
